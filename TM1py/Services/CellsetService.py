...
from TM1py.Utils.Utils import build_pandas_dataframe_from_cellset, dimension_name_from_element_unique_name, \
    ...
    drop_dimension_properties, decohints, verify_version, lower_and_drop_spaces, build_object_name_from_url_friendly
...
class CellsetService(ObjectService):
    ...
    def create_cellset(self, view: Optional[View | str] = None, cube: Optional[Cube | str] = None, mdx: Optional[str | MdxBuilder] = None, private: bool = False, sandbox_name: str = None,
        ...
        :type cube: Optional[Cube | str]
        :param mdx: An MDX query string or MdxBuilder object used to define the query.
        :type mdx: Optional[str | MdxBuilder]
        :param private: Whether the view is private or public. Defaults to False.
        :type private: bool
        :param sandbox_name: Name of the sandbox to use, if applicable.
        :type sandbox_name: Optional[str]
        :param kwargs: Additional keyword arguments for advanced configurations.
        :type kwargs: dict

        :return: The ID of the created cellset.
        :rtype: str
