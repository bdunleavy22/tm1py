...
class TestDataService(unittest.TestCase):
    ...
    def _write_attribute_values(cls):
        for dimension_name in cls.dimension_names:
            ...
            cls.tm1.data.write(cube=attribute_cube, cellset_as_dict=attribute_values)
    ...
    def setUp(self):
        ...
        self.tm1.data.write_values(self.cube_name, self.cellset)

        self.tm1.data.write_values(self.string_cube_name, self.cells_in_string_cube)
    ...
    def create_cube_with_five_dimensions(cls):
        ...
        cls.tm1.data.write(cube=cls.cube_with_five_dimensions, cellset_as_dict=cells)
    ...
    def create_or_update_dimension_with_hierarchies(cls):
        ...
        cls.tm1.data.write(cube="}ElementAttributes_" + cls.dimension_with_hierarchies_name, values="123", elements=[((cls.dimension_with_hierarchies_name, "Hierarchy1","Elem1"), "ea1")])
        cls.tm1.data.write(cube="}ElementAttributes_" + cls.dimension_with_hierarchies_name, values="ABC", elements=[((cls.dimension_with_hierarchies_name, "Hierarchy2","Cons1"), "ea2")])
        cls.tm1.data.write(cube="}ElementAttributes_" + cls.dimension_with_hierarchies_name, values="DEF", elements=[((cls.dimension_with_hierarchies_name, "Hierarchy3","Cons2"), "ea2")])

    def test_write_and_get_value(self):
        original_value = self.tm1.data.get_values(cube=self.cube_name, elements=('Element1','EleMent2','ELEMENT  3'))
        response = self.tm1.data.write(values=1, cube=self.cube_name, elements=('element1', 'ELEMENT 2', 'EleMent  3'))
        self.assertTrue(response.ok)
        # value = self.tm1.data.get_value(self.cube_name, 'Element1,EleMent2,ELEMENT  3')
        # self.assertEqual(value, 1)
        # response = self.tm1.data.write_value(2, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
        # self.assertTrue(response.ok)
        # value = self.tm1.data.get_value(self.cube_name, 'Element1,EleMent2,ELEMENT  3')
        # self.assertEqual(value, 2)
        self.tm1.data.write(values=original_value, cube=self.cube_name, elements=('element1', 'ELEMENT 2', 'EleMent  3'))

    # def test_get_value_iterator(self):
    #     original_value = self.tm1.data.get_value(self.cube_name, 'Element1, Element2, Element3')
    #     response = self.tm1.data.write_value(3, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #     self.assertTrue(response.ok)
    #     value = self.tm1.data.get_value(self.cube_name, (
    #         (self.dimension_names[0], 'Element1'),
    #         (self.dimension_names[1], 'EleMent2'),
    #         (self.dimension_names[2], 'ELEMENT  3')
    #     ))
    #     self.assertEqual(value, 3)
    #     self.tm1.data.write_value(original_value, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #
    # def test_write_and_get_value_hierarchy(self):
    #     original_value = self.tm1.data.get_value(self.cube_name, 'Element1,EleMent2,ELEMENT  3')
    #     response = self.tm1.data.write_value(4, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #     self.assertTrue(response.ok)
    #     value = self.tm1.data.get_value(
    #         self.cube_name,
    ...
    #     original_value = self.tm1.data.get_value(self.cube_name, 'Element1, Element2, Element3')
    #     response = self.tm1.data.write_value(5, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #     self.assertTrue(response.ok)
    #     value = self.tm1.data.get_value(self.cube_name, [
    ...
    #     original_value = self.tm1.data.get_value(self.cube_name, 'Element1,EleMent2,ELEMENT  3')
    #     response = self.tm1.data.write_value(6, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #     self.assertTrue(response.ok)
    #     value = self.tm1.data.get_value(
    #         self.cube_name,
    #         f'{self.dimension_names[0]}$$Element1;EleMent2;{self.dimension_names[2]}  $$ ELEMENT  3',
    ...
    #     original_value = self.tm1.data.get_value(self.cube_name, 'Element1,EleMent2,ELEMENT  3')
    #     response = self.tm1.data.write_value(7, self.cube_name, ('element1', 'ELEMENT 2', 'EleMent  3'))
    #     self.assertTrue(response.ok)
    #     value = self.tm1.data.get_value(self.cube_name, element_string='Element1,EleMent2,ELEMENT  3')
    ...
    #
    #     self.tm1.data.write_values(self.cube_name, cells)
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [716])
    #
    # def test_write(self):
    #     cells = {("Element 1", "Element4", "Element9"): 717}
    #     self.tm1.data.write(self.cube_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [717])
    #
    # def test_write_use_ti(self):
    #     cells = {("Element 1", "Element4", "Element9"): 1234}
    #     self.tm1.data.write(self.cube_name, cells, use_ti=True, use_changeset=False)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [1234])
    #
    # def test_write_use_blob(self):
    #     cells = {("Element 1", "Element4", "Element9"): 1234}
    #     self.tm1.data.write(self.cube_name, cells, use_blob=True, use_changeset=False)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #     try:
    #         self.tm1.data.write(self.cube_with_consolidations_name, cells, use_blob=True, allow_spread=True)
    ...
    #
    #     self.assertAlmostEqual(54321, self.tm1.data.execute_mdx_values(mdx=query.to_mdx())[0], delta=0.0001)
    #
    # def test_write_use_ti_allow_spread(self):
    #     cells = {("Element 1", "Element4", "Element9"): 1,
    #              ("Element 1", "Element4", "TOTAL_TM1py_Tests_Cell_Dimension3_With_Consolidations"): 54321}
    #     try:
    #         self.tm1.data.write(self.cube_with_consolidations_name, cells, use_ti=True, allow_spread=True)
    #     except (TM1pyWriteFailureException, TM1pyWritePartialFailureException) as ex:
    #         for log_file in ex.error_log_files:
    #             print(self.tm1.processes.get_error_log_file_content(log_file))
    #
    ...
    #
    #     self.tm1.data.write(self.cube_with_consolidations_name, cells, use_ti=True, skip_non_updateable=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_with_consolidations_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimensions_with_consolidations_names[0]}].[Element 1]",
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [8])
    #
    ...
    #
    #     self.tm1.data.write(self.cube_with_consolidations_name, cells, skip_non_updateable=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_with_consolidations_name)
    #     query.add_member_tuple_to_columns(
    ...
    #
    #     self.tm1.data.write(self.cube_name, cells)
    #     self.tm1.data.write(self.cube_name, cells, increment=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [422])
    #
    # def test_write_increment_false(self):
    #     cells = {("Element 1", "Element5", "Element8"): 211}
    #
    #     self.tm1.data.write(self.cube_name, cells)
    #     self.tm1.data.write(self.cube_name, cells, increment=False)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 8]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [211])
    #
    # def test_write_through_unbound_process_happy_case(self):
    #     cells = dict()
    #     cells["Element 1", "Element4", "Element9"] = 719
    #     self.tm1.data.write_through_unbound_process(self.cube_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [719])
    #
    # def test_write_through_unbound_process_sandbox(self):
    #     cells = dict()
    #     cells["Element 1", "Element4", "Element9"] = 7192
    #     self.tm1.data.write_through_unbound_process(self.cube_name, cells, sandbox_name=self.sandbox_name)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx(), sandbox_name=self.sandbox_name), [7192])
    #
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [10000.1234567891])
    #
    # def test_write_through_unbound_process_str(self):
    #     cells = dict()
    #     cells["d1e1", "d2e4", "d3e3"] = 'TM1py Test'
    #     self.tm1.data.write_through_unbound_process(self.string_cube_name, cells)
    #
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), ['TM1py Test'])
    #
    ...
    #     self.tm1.data.write_through_unbound_process("}ElementAttributes_" + self.dimension_names[0], cells)
    #
    ...
    #         f"[{self.dimension_names[0]}].[element2]",
    #         f"[}}ElementAttributes_{self.dimension_names[0]}].[Attr3]")
    #     values = self.tm1.data.execute_mdx_values(mdx=query.to_mdx())
    #
    ...
    #         self.tm1.data.write_through_unbound_process(self.cube_with_consolidations_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.cube_with_consolidations_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimensions_with_consolidations_names[0]}].[Element 1]",
    ...
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [5])
    #
    ...
    #         f"[{self.dimensions_with_consolidations_names[2]}].[Element 9]")
    #
    #     self.assertEqual([8], self.tm1.data.execute_mdx_values(mdx=query.to_mdx()))
    #
    ...
    #     cells = dict()
    #     cells["Element 1", "Element4", "Element9"] = 719
    #     self.tm1.data.write_through_blob(self.cube_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #     cells = dict()
    #     cells["Element 1", "Element4", "Element9"] = 7192
    #     self.tm1.data.write_through_blob(self.cube_name, cells, sandbox_name=self.sandbox_name)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         self.tm1.data.execute_mdx_values(mdx=query.to_mdx())[0],
    #         10000.1234567891,
    #         8)
    #
    ...
    #     cells = dict()
    #     cells["d1e1", "d2e4", "d3e3"] = 'TM1py Test'
    #     self.tm1.data.write_through_blob(self.string_cube_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.string_cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.string_dimension_names[0]}].[d1e1]",
    ...
    #     cells["element2", "Attr2"] = 0
    #     cells["element2", "Attr3"] = None
    #     self.tm1.data.write_through_blob("}ElementAttributes_" + self.dimension_names[0], cells)
    #
    #     query = MdxBuilder.from_cube("}ElementAttributes_" + self.dimension_names[0])
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[element1]",
    ...
    #         f"[}}ElementAttributes_{self.dimension_names[0]}].[Attr3]")
    #
    #     result = self.tm1.data.execute_mdx_values(mdx=query.to_mdx())
    #
    ...
    #
    #     with self.assertRaises(TM1pyWritePartialFailureException):
    #         self.tm1.data.write_through_blob(self.cube_with_consolidations_name, cells)
    #
    #     query = MdxBuilder.from_cube(self.cube_with_consolidations_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimensions_with_consolidations_names[0]}].[Element 1]",
    ...
    #
    #     changeset = self.tm1.data.write(self.cube_name, cells, use_changeset=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    ...
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [3.3])
    #
    #     self.tm1.data.undo_changeset(changeset=changeset)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 12]",
    #         f"[{self.dimension_names[1]}].[Element 13]",
    #         f"[{self.dimension_names[2]}].[Element 15]")
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [None])
    #
    # def test_undo_cellset_write_values(self):
    #     cells = dict()
    #     cells["Element 16", "Element 13", "Element 15"] = 3.6
    #
    #     changeset = self.tm1.data.write_values(self.cube_name, cells, use_changeset=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    ...
    #         f"[{self.dimension_names[1]}].[Element 13]",
    #         f"[{self.dimension_names[2]}].[Element 15]")
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [3.6])
    #
    #     self.tm1.data.undo_changeset(changeset=changeset)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    ...
    #         f"[{self.string_dimension_names[2]}].[d3e3]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), ['TM1py Test1', 'TM1py Test2'])
    #
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [0.00000001])
    #
    ...
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [12_300_000_000])
    #
    ...
    #         f"[{self.dimension_names[1]}].[Element 4]",
    #         f"[{self.dimension_names[2]}].[Element 9]")
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [702])
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 2]",
    #         f"[{self.dimension_names[1]}].[Element 4]",
    #         f"[{self.dimension_names[2]}].[Element 7]")
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [701])
    #
    # def test_write_through_blob_increment_true(self):
    #     cells = {("Element 1", "Element5", "Element8"): 111}
    #
    #     self.tm1.data.write_through_blob(self.cube_name, cells)
    #     self.tm1.data.write_through_blob(self.cube_name, cells, increment=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 8]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [222])
    #
    # def test_write_through_blob_increment_false(self):
    #     cells = {("Element 1", "Element5", "Element8"): 109}
    #
    #     self.tm1.data.write_through_blob(self.cube_name, cells)
    #     self.tm1.data.write_through_blob(self.cube_name, cells, increment=False)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query.add_member_tuple_to_columns(
    #         f"[{self.dimension_names[0]}].[Element 1]",
    ...
    #         f"[{self.dimension_names[2]}].[Element 8]")
    #
    #     self.assertEqual(self.tm1.data.execute_mdx_values(mdx=query.to_mdx()), [109])
    #
    # @skip_if_no_pandas
    ...
    #         "Value": [1.0, 2.0, 3.0]})
    #
    #     self.tm1.data.write_dataframe(self.cube_name, df)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    ...
    #     values = self.tm1.data.execute_mdx_values(query.to_mdx())
    #
    ...
    #         "Value": [1.0, 2.0, 3.0]})
    #
    #     self.tm1.data.write_dataframe(self.cube_name, df, infer_column_order=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query = query.add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.member(Member.of(self.dimension_names[0], "element 1")))
    ...
    #         self.dimension_names[2]: ["element 1", "element 1", "element 1"],
    #         "Value": [1.0, 2.0, 3.0]})
    #     self.tm1.data.write_dataframe(self.cube_name, df, use_blob=True)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query = query.add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.member(Member.of(self.dimension_names[0], "element 1")))
    ...
    #     self.tm1.data.write_dataframe(self.string_cube_name, df)
    #
    #     query = MdxBuilder.from_cube(self.string_cube_name)
    #     query = query.add_hierarchy_set_to_column_axis(
    ...
    #         self.dimension_names[2]: ["element 5", "element 5", "element 5"],
    #         "Value": [1, 2, 3]})
    #     self.tm1.data.write_dataframe_async(self.cube_name, df, 1, 3)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query = query.add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.member(Member.of(self.dimension_names[0], "element 1")))
    ...
    #
    #     with self.assertRaises(TM1pyWritePartialFailureException) as ex:
    #         self.tm1.data.write_dataframe_async(self.cube_name, df, 1, 5)
    ...
    #
    #     self.tm1.data.write_async(self.cube_name, cells, 1, 3)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    #     query = query.add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.member(Member.of(self.dimension_names[0], "element 1")))
    ...
    #
    #     with self.assertRaises(TM1pyWritePartialFailureException) as ex:
    #         self.tm1.data.write_async(self.cube_name, cells, 1, 5)
    #     self.assertEqual(2, ex.exception.attempts)
    #     self.assertEqual(['HasMinorErrors', 'HasMinorErrors'], ex.exception.statuses)
    #
    #     query = MdxBuilder.from_cube(self.cube_name)
    ...
    #         ('e1', 'e3'): 3,
    #     }
    #     self.tm1.data.write_values(self.cube_rps1_name, cells)
    #
    #     self.tm1.data.relative_proportional_spread(
    #         value=12,
    ...
    #         ('e1', 'e3'): 3,
    #     }
    #     self.tm1.data.write_values(self.cube_rps2_name, cells)
    #
    #     self.tm1.data.relative_proportional_spread(
    #         value=12,
    #         cube=self.cube_rps1_name,
    ...
    #         .to_mdx()
    #     data = self.tm1.data.execute_mdx(mdx, max_workers=max_workers)
    ...
    #         .to_mdx()
    #     # MDX with top
    #     data = self.tm1.data.execute_mdx(mdx, top=5, max_workers=max_workers)
    #     # Check if total value is the same AND coordinates are the same. Handle None
    ...
    #     data = self.tm1.data.execute_mdx(mdx, cell_properties=["Value", "Ordinal"], max_workers=max_workers)
    ...
    #         .to_mdx()
    #
    #     data = self.tm1.data.execute_mdx(mdx, use_compact_json=True)
    #     # Check if total value is the same AND coordinates are the same. Handle None
    ...
    #         .to_mdx()
    #     data = self.tm1.data.execute_mdx(mdx, max_workers=max_workers, async_axis=0)
    #     # Check if total value is the same AND coordinates are the same. Handle None
    #     self.assertEqual(
    #         self.total_value, sum(v["Value"] for v in data.values() if v["Value"])
    #     )
    ...
    #         .to_mdx()
    #     data = self.tm1.data.execute_mdx(mdx, max_workers=max_workers, async_axis=1)
    #     # Check if total value is the same AND coordinates are the same. Handle None
    #     self.assertEqual(
    #         self.total_value, sum(v["Value"] for v in data.values() if v["Value"])
    #     )
    ...
    #     data = self.tm1.data.execute_mdx(mdx, skip_contexts=True, max_workers=max_workers)
    ...
    #     data = self.tm1.data.execute_mdx(
    #         query.to_mdx(),
    #         skip_contexts=True,
    ...
    #     cells = self.tm1.data.execute_mdx(
    #         q.to_mdx(),
    ...
    #     data = self.tm1.data.execute_mdx(q.to_mdx(), skip_cell_properties=True, max_workers=max_workers)
    ...
    #         .add_member_to_where("[" + self.dimension_names[2] + "].[Element1]").to_mdx()
    #
    #     raw_response = self.tm1.data.execute_mdx_raw(
    #         mdx,
    #         skip_contexts=True,
    ...
    #         .add_member_to_where("[" + self.dimension_names[2] + "].[Element1]").to_mdx()
    #
    #     raw_response = self.tm1.data.execute_mdx_raw(mdx, include_hierarchies=True)
    #
    ...
    #
    #     # MDX with top
    #     raw_response = self.tm1.data.execute_mdx_raw(mdx, top=5)
    #
    ...
    #         .add_member_to_where("[" + self.dimension_names[2] + "].[Element1]").to_mdx()
    #
    #     data = self.tm1.data.execute_mdx_rows_and_values(mdx, element_unique_names=True)
    #
    #     self.assertEqual(len(data), 1)
    ...
    #     self.tm1.data.write_values(self.cube_name, {("Element10", "Element11", "Element13"): 0})
    #
    #     mdx = MdxBuilder.from_cube(self.cube_name) \
    #         .rows_non_empty() \
    ...
    #         .add_member_to_where("[" + self.dimension_names[2] + "].[Element1]").to_mdx()
    #
    #     data = self.tm1.data.execute_mdx_rows_and_values(mdx, element_unique_names=False)
    #
    #     self.assertEqual(len(data), 1)
    #     for row, cells in data.items():
    #         member_name = row[0]
    ...
    #
    #     data = self.tm1.data.execute_mdx_rows_and_values(query.to_mdx())
    #
    ...
    #         .to_mdx()
    #
    #     raw = self.tm1.data.execute_mdx_raw(
    #         mdx=mdx,
    ...
    #         .to_mdx()
    #
    #     cell_values = self.tm1.data.execute_mdx_values(mdx)
    ...
    #                                              self.dimension_names[2])
    #
    #     data = self.tm1.data.execute_mdx_values(mdx)
    #     self.assertEqual(
    #         1000,
    #         len(list(data)))
    #     data = self.tm1.data.execute_mdx_values(mdx)
    ...
    #         .to_mdx()
    #
    #     cell_values = self.tm1.data.execute_mdx_values(mdx, use_compact_json=True)
    #     self.assertIsInstance(
    #         cell_values,
    #         list)
    #     # Check if total value is the same. Handle None.
    ...
    #         .to_mdx()
    #     values = self.tm1.data.execute_mdx_values(mdx, skip_zeros=True)
    #
    ...
    #         .to_mdx()
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx)
    #
    #     # check header
    #     header = csv.split('\r\n')[0]
    #     self.assertEqual(
    ...
    #         .to_mdx()
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_iterative_json=True)
    #
    #     # check header
    #     header = csv.split('\r\n')[0]
    #     self.assertEqual(
    ...
    #         .to_mdx()
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, skip_rule_derived_cells=True)
    #
    #     self.assertEqual("", csv)
    #
    ...
    #         .to_mdx()
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, top=10, skip_zeros=False)
    #
    #     records = csv.split("\r\n")
    ...
    #         .to_mdx()
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, skip=10, skip_zeros=False)
    #
    #     records = csv.split("\r\n")
    ...
    #         .add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.all_members(self.dimension_names[2], self.dimension_names[2]))
    #     csv = self.tm1.data.execute_mdx_csv(query, use_blob=True)
    #
    #     # check header
    #     header = csv.split('\r\n')[0]
    #     self.assertEqual(
    ...
    #         .add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.all_members(self.dimension_names[2], self.dimension_names[2]))
    #     csv = self.tm1.data.execute_mdx_csv(query.to_mdx(skip_dimension_properties=True), use_blob=True)
    #
    #     # check header
    #     header = csv.split('\r\n')[0]
    #     self.assertEqual(
    ...
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_blob=True)
    #
    ...
    #         .where(Member.of(self.dimension_names[2], "Element 2"))
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx.to_mdx(skip_dimension_properties=True), use_blob=True)
    #
    #     # ignore double quote in comparison and drop \r\n at file end
    #     records = csv.strip().replace('"', '').split('\r\n')
    #     self.assertEqual(2, len(records))
    ...
    #         .add_member_to_where(Member.of(self.dimension_names[0], "Element1"))
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_blob=True, skip_rule_derived_cells=True)
    #
    #     self.assertEqual("", csv)
    #
    ...
    #         .add_member_to_where(Member.of(self.dimension_names[0], "Element1"))
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_blob=True, top=10, skip_zeros=False)
    #
    ...
    #         .add_member_to_where(Member.of(self.dimension_names[0], "Element1"))
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_blob=True, skip=10, skip_zeros=False)
    #
    ...
    #         MdxHierarchySet.member(Member.of(self.dimension_names[1], "Calculated Member")))
    #
    #     csv = self.tm1.data.execute_mdx_csv(mdx, use_blob=False)
    #
    #     # check header
    #     header = csv.split('\r\n')[0]
    #     self.assertEqual(
    ...
    #         .to_mdx()
    #
    #     values = self.tm1.data.execute_mdx_elements_value_dict(mdx)
    #
    #     # check type
    ...
    #         .to_mdx()
    #
    #     df = self.tm1.data.execute_mdx_dataframe(mdx)
    #
    #     # check type
    ...
    #
    #     df = self.tm1.data.execute_mdx_dataframe(query.to_mdx())
    #     self.assertEqual(
    #         [["NA", "Element 1", 4.0]],
    #         df.values.tolist())
    #
    ...
    #         .to_mdx()
    #
    #     df = self.tm1.data.execute_mdx_dataframe(mdx, use_iterative_json=True)
    #
    #     # check type
    #     self.assertIsInstance(df, pd.DataFrame)
    #
    ...
    #     """
    #
    #     df = self.tm1.data.execute_mdx_dataframe(mdx, include_attributes=True)
    ...
    #     """
    #
    #     df = self.tm1.data.execute_mdx_dataframe(mdx, include_attributes=True, use_iterative_json=True)
    #     # integerize numeric columns because v12 attribute numbers are different from v11 ('2.0' vs '2')
    #     df[['Attr3', 'Attr2', 'Value']] = df[['Attr3', 'Attr2', 'Value']].apply(
    #         lambda col: pd.to_numeric(col).fillna(0).astype(int))
    #
    ...
    #         .to_mdx()
    #
    #     pivot = self.tm1.data.execute_mdx_dataframe_pivot(mdx=mdx)
    ...
    #         .add_hierarchy_set_to_column_axis(
    #         MdxHierarchySet.all_members(self.dimension_names[2], self.dimension_names[2]))
    #     df = self.tm1.data.execute_mdx_dataframe(mdx, use_blob=True)
    #
    #     # check type
    #     self.assertIsInstance(df, pd.DataFrame)
    #
    ...
    #
    #     df = self.tm1.data.execute_mdx_dataframe(query, use_blob=True)
    #     self.assertEqual(
    #         [["Element 1", "NA", 4.0]],
    #         df.values.tolist())
    #
    ...
    #         .to_mdx()
    #
    #     df = self.tm1.data.execute_mdx_dataframe(mdx=mdx, top=1, skip=2, use_blob=True, skip_zeros=False)
    ...
    #     df_async = self.tm1.data.execute_mdx_dataframe_async(mdx_list, max_workers=max_workers)
    #     # check type
    ...
    #
    #     # check execution with different max_worker parameter
    #     df_async1 = self.tm1.data.execute_mdx_dataframe_async(mdx_list, max_workers=2, use_blob=True)
    #     df_async2 = self.tm1.data.execute_mdx_dataframe_async(mdx_list, max_workers=5, use_blob=True)
    #     df_async3 = self.tm1.data.execute_mdx_dataframe_async(mdx_list, max_workers=8, use_blob=True)
    #
    #     # check type
    ...
    #     df = self.tm1.data.execute_mdx_dataframe(mdx)
    #     # build a reference "single-threaded" df for comparison
    #     df_async = self.tm1.data.execute_mdx_dataframe_async([mdx])
    #
    #     # check type
    #     self.assertIsInstance(df_async, pd.DataFrame)
    #
    ...
    #         .to_mdx()
    #
    #     cell_count = self.tm1.data.execute_mdx_cellcount(mdx)
    ...
    #         .to_mdx()
    #
    #     elements_and_string_values = self.tm1.data.execute_mdx_rows_and_values_string_set(mdx)
    #
    #     self.assertEqual(
    ...
    #         .to_mdx()
    #
    #     elements_and_string_values = self.tm1.data.execute_mdx_rows_and_values_string_set(
    #         mdx=mdx,
    ...
    #
    #     elements_and_string_values = self.tm1.data.execute_view_rows_and_values_string_set(
    ...
    #     data = self.tm1.data.execute_view(
    ...
    #
    #     data = self.tm1.data.execute_view_rows_and_values(
    #         cube_name=self.cube_name,
    #         view_name=view_name,
    #         private=False)
    #
    ...
    #             private=False)
    #
    #     raw_response = self.tm1.data.execute_view_raw(
    #         cube_name=self.cube_name,
    #         view_name=view_name,
    #         private=False,
    #         skip_contexts=True,
    ...
    #     raw = self.tm1.data.execute_view_raw(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False,
    #         cell_properties=["Value", "RuleDerived"],
    ...
    #     cell_values = self.tm1.data.execute_view_values(cube_name=self.cube_name, view_name=self.view_name,
    #                                                      private=False)
    #
    #     # check type
    ...
    #     csv = self.tm1.data.execute_view_csv(cube_name=self.cube_name, view_name=self.view_name, private=False)
    #
    #     # check type
    #     self.assertIsInstance(csv, str)
    #     records = csv.split('\r\n')[1:]
    ...
    #     csv = self.tm1.data._execute_view_csv_use_blob(
    #         top=None,
    #         skip=None,
    #         skip_zeros=True,
    ...
    #     values = self.tm1.data.execute_view_elements_value_dict(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False)
    #
    ...
    #     df = self.tm1.data.execute_view_dataframe(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False)
    #
    ...
    #     df = self.tm1.data.execute_view_dataframe_shaped(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False,
    #         mdx_headers=True)
    ...
    #     self.tm1.views.update_or_create(view, private=False)
    #
    #     pivot = self.tm1.data.execute_view_dataframe_pivot(
    #         cube_name=self.cube_name,
    #         view_name=view_name)
    ...
    #     cell_count = self.tm1.data.execute_view_cellcount(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False)
    #     self.assertGreater(cell_count, 1000)
    ...
    #         .to_mdx()
    #
    #     self.tm1.data.execute_mdx_ui_array(mdx=mdx)
    #
    # def test_execute_view_ui_array(self):
    #     self.tm1.data.execute_view_ui_array(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False)
    #
    ...
    #         .to_mdx()
    #
    #     self.tm1.data.execute_mdx_ui_dygraph(mdx=mdx)
    #
    # def test_execute_view_ui_dygraph(self):
    #     self.tm1.data.execute_view_ui_dygraph(
    #         cube_name=self.cube_name,
    #         view_name=self.view_name,
    #         private=False)
    #
    ...
    #         .to_mdx()
    #
    #     self.tm1.data.write_values_through_cellset(mdx, (1.5,))
    #
    #     # check value on coordinate in cube
    #     values = self.tm1.data.execute_mdx_values(mdx)
    ...
    #
    #     self.tm1.data.write_values_through_cellset(query.to_mdx(), (1.5,), deactivate_transaction_log=True)
    #
    #     # check value on coordinate in cube
    #     values = self.tm1.data.execute_mdx_values(query.to_mdx())
    #     self.assertEqual(values[0], 1.5)
    #
    #     self.assertFalse(self.tm1.data.transaction_log_is_active(self.cube_name))
    #
    # @skip_if_version_higher_or_equal_than(version='12')
    ...
    #         .to_mdx()
    #
    #     self.tm1.data.write_values_through_cellset(
    #         mdx,
    #         (1.5,),
    ...
    #
    #     self.assertEqual(values[0], 1.5)
    #     self.assertTrue(self.tm1.data.transaction_log_is_active(self.cube_name))
    #
    # @skip_if_version_higher_or_equal_than(version='12')
    # def test_deactivate_transaction_log(self):
    #     self.tm1.data.write_value(value="YES",
    #                                cube_name="}CubeProperties",
    #                                element_tuple=(self.cube_name, "Logging"))
    #     self.tm1.data.deactivate_transactionlog(self.cube_name)
    #     value = self.tm1.data.get_value("}CubeProperties", "{},LOGGING".format(self.cube_name))
    #     self.assertEqual("NO", value.upper())
    #
    # @skip_if_version_higher_or_equal_than(version='12')
    # def test_activate_transaction_log(self):
    #     self.tm1.data.write_value(value="NO",
    #                                cube_name="}CubeProperties",
    #                                element_tuple=(self.cube_name, "Logging"))
    #     self.tm1.data.activate_transactionlog(self.cube_name)
    #     value = self.tm1.data.get_value("}CubeProperties", "{},LOGGING".format(self.cube_name))
    #     self.assertEqual("YES", value.upper())
    #
    # def test_read_write_with_custom_encoding(self):
    #     coordinates = ("d1e1", "d2e2", "d3e3")
    #     self.tm1.data.write_values(self.string_cube_name, {coordinates: self.latin_1_encoded_text},
    #                                 encoding="latin-1")
    #
    #     mdx = MdxBuilder.from_cube(self.string_cube_name) \
    #         .add_hierarchy_set_to_column_axis(
    ...
    #         .to_mdx()
    #
    #     values = self.tm1.data.execute_mdx_values(mdx=mdx, encoding="latin-1")
    ...
    #         .to_mdx()
    #
    #     values = self.tm1.data.execute_mdx_values(mdx=mdx)
    #
    ...
    #         .to_mdx()
    #
    #     self.tm1.data.clear_with_mdx(cube=self.cube_name, mdx=mdx)
    #
    #     value = self.tm1.data.execute_mdx_values(mdx=mdx)[0]
    ...
    #     }
    #     self.tm1.data.clear(cube=self.cube_name, **kwargs)
    #
    #     mdx = MdxBuilder.from_cube(self.cube_name) \
    ...
    #     }
    #
    #     self.tm1.data.clear_with_dataframe(cube=self.cube_name, df=pd.DataFrame(data))
    #
    #     mdx = MdxBuilder.from_cube(self.cube_name) \
    #         .add_hierarchy_set_to_row_axis(MdxHierarchySet.member(Member.of(self.dimension_names[0], "Element17"))) \
    #         .add_hierarchy_set_to_column_axis(MdxHierarchySet.member(Member.of(self.dimension_names[1], "Element21"))) \
    ...
    #     }
    #
    #     self.tm1.data.clear_with_dataframe(
    #         cube=self.cube_name,
    ...
    #         .to_mdx()
    #
    #     cells = self.tm1.data.execute_mdx(mdx=mdx, skip=2)
    #     self.assertEqual(len(cells), 2)
    #
    ...
    #         .to_mdx()
    #
    #     cells = self.tm1.data.execute_mdx(mdx=mdx, top=1, skip=2)
    #     self.assertEqual(len(cells), 1)
    #
    #     elements = element_names_from_element_unique_names(list(cells.keys())[0])
    #     self.assertEqual(elements, ("Element 2", "Element 1", "Element 1"))
    ...
    #     pre_state = self.tm1.data.transaction_log_is_active(self.cube_name)
    #
    #     self.tm1.data.write_values(
    #         self.cube_name,
    #         self.cellset,
    ...
    #
    #     self.assertEqual(pre_state, self.tm1.data.transaction_log_is_active(self.cube_name))
    #
    # @skip_if_version_higher_or_equal_than(version='12')
    ...
    #         .to_mdx()
    #
    #     values = self.tm1.data.execute_mdx_values(mdx, sandbox_name=self.sandbox_name)
    ...
    #         .to_mdx()
    #
    #     result = self.tm1.data.execute_mdx(mdx, sandbox_name=self.sandbox_name)
    ...
    #         .to_mdx()
    #
    #     result = self.tm1.data.execute_mdx_rows_and_values(mdx, sandbox_name=self.sandbox_name)
    #     self.assertEqual(1, len(result))
    ...
    #     values = self.tm1.data.get_values(
    #         cube_name=self.cube_name,
    ...
    #     result = self.tm1.data.trace_cell_calculation(
    ...
    #     result = self.tm1.data.trace_cell_feeders(
    #         cube_name=self.cube_with_rules_name,
    #         elements="Element1,Element1,Element1")
    #
    ...
    #     result = self.tm1.data.check_cell_feeders(
    #         cube_name=self.cube_with_rules_name,
    #         elements="Element1,Element1,Element1")
    #
    ...
    #         .to_mdx()
    #
    #     result = self.tm1.data.execute_mdx_csv(mdx, mdx_headers=True)
    #
    ...
    #         .to_mdx()
    #
    #     result = self.tm1.data.execute_mdx_csv(mdx, use_blob=True, mdx_headers=True)
    #
    #     expected_result = '"[TM1py_Tests_Cell_Dimension2].[TM1py_Tests_Cell_Dimension2]",' \
    #                       '"[TM1py_Tests_Cell_Dimension1].[TM1py_Tests_Cell_Dimension1]",' \
    #                       '"Value"\r\n' \
    ...
    #         .to_mdx()
    #
    #     result = self.tm1.data.execute_mdx_csv(mdx, use_iterative_json=True, mdx_headers=True)
    #
    #     expected_result = "[TM1py_Tests_Cell_Dimension2].[TM1py_Tests_Cell_Dimension2]," \
    #                       "[TM1py_Tests_Cell_Dimension1].[TM1py_Tests_Cell_Dimension1]," \
    #                       "Value\r\n" \
    ...
    #     )
    #
    #     result = self.tm1.data.execute_view_csv(cube_name=self.cube_name, view_name=self.mdx_view_2_name,
    #                                              mdx_headers=True)
    #
    #     expected_result = "[TM1py_Tests_Cell_Dimension2].[TM1py_Tests_Cell_Dimension2]," \
    #                       "[TM1py_Tests_Cell_Dimension1].[TM1py_Tests_Cell_Dimension1]," \
    ...
    #
    #     # create cellset
    #     cellset = self.tm1.data.create_cellset(mdx)
    #
    #     partition = self.tm1.data.extract_cellset_partition(
    #         cellset_id=cellset,
    ...
    #
    #     partition_skip_zero = self.tm1.data.extract_cellset_partition(
    #         cellset_id=cellset,
    #         partition_start_ordinal=0,
    #         partition_end_ordinal=1,
    #         skip_zeros=True)
    ...
    #         .to_mdx()
    #
    #     cellset_id = self.tm1.data.create_cellset(mdx=mdx)
    #     data_async0 = self.tm1.data.extract_cellset_axes_raw_async(cellset_id=cellset_id, async_axis=0)
    #     data_async1 = self.tm1.data.extract_cellset_axes_raw_async(cellset_id=cellset_id)
    #     data = self.tm1.data.extract_cellset_metadata_raw(cellset_id=cellset_id)
    #     self.assertEqual(
    ...
    #     cellset_id = self.tm1.data.create_cellset(mdx=mdx)
    #     data_async0 = self.tm1.data.extract_cellset_axes_raw_async(cellset_id=cellset_id, async_axis=0)
    #     data = self.tm1.data.extract_cellset_metadata_raw(cellset_id=cellset_id, delete_cellset=False)
    #     self.assertEqual(data['Axes'], data_async0['Axes'])
    #
    #     print('axes empty row', len(data['Axes']))
    #     with self.assertRaises(ValueError) as _:
    #         self.tm1.data.extract_cellset_axes_raw_async(cellset_id=cellset_id)
    #
    ...
    #         self.tm1.data.extract_cellset_cellcount(cellset_id)
    #
    ...
    #
    #     cellset_id = self.tm1.data.create_cellset(mdx=mdx)
    #     data_async = self.tm1.data.extract_cellset_cells_raw_async(cellset_id=cellset_id)
    #     data = self.tm1.data.extract_cellset_cells_raw(cellset_id=cellset_id)
    #     self.assertEqual(
    ...
    #     self.tm1.data.write_values(self.cube_with_consolidations_name, self.cellset)
    ...
    #
    #     df = self.tm1.data.execute_mdx_dataframe(
    #         mdx=mdx.to_mdx(),
